...
class AllChaptersFeed(Feed):
    ...
    def item_link(self, item):
        return f"https://youzitsu.ga/read/manga/{item.series.slug}/{Chapter.slug_chapter_number(item)}/1"
...
class SeriesChaptersFeed(Feed):
    ...
    def link(self, obj):
        return f"https://youzitsu.ga/read/manga/{obj.slug}/"
    ...
    def item_link(self, obj):
        return f"https://youzitsu.ga/read/manga/{obj.series.slug}/{Chapter.slug_chapter_number(obj)}/1"
